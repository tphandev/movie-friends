...
import { getPopularMovies } from "@/utilis/api";
...
export default async function Page({
  ...
  const popularMovies = await getData(page);
    ...
    <main className="mt-24 lg:mt-28">
      <section className="lg:mf-grid  lg:px-0">
        <div className="lg:col-span-12 flex items-end justify-between px-2 pb-2 lg:pb-0 lg:px-0">
          <h1 className="font-bold text-3xl lg:text-5xl">Popular Movies</h1>
          <div className="flex gap-4 md:gap-8">
            {page > 1 && (
              <Link
                href={{ pathname: "/popular", query: { page: page - 1 } }}
