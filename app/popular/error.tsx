...
export default function Error({
  ...
  return (
    <main className="lg:mf-grid mb-10 flex flex-col gap-8 p-4 pt-36 lg:mb-32 xl:mb-80 lg:pt-64">
      <div className="flex flex-col gap-4 lg:col-span-5 lg:col-start-3">
        <h1 className="text-xl lg:text-3xl font-bold uppercase text-gray-400">
          Opps! Something went wrong!
        </h1>
        <h2 className="text-lg mt-2">{error.message}</h2>
      </div>
